...
#define THERMAL_PROTECTION_PERIOD 300//Modified by FK 17-4-2017
#define THERMAL_PROTECTION_HYSTERESIS 10 //Modified by FK 17-4-2017
   ...
   */
#define WATCH_TEMP_PERIOD 300 //Modified by FK 17-4-2017
#define WATCH_TEMP_INCREASE 10 //Modified by FK 17-4-2017
#endif
...
#define THERMAL_PROTECTION_BED_PERIOD 300 //Modified by FK 17-4-2017
#define THERMAL_PROTECTION_BED_HYSTERESIS 10 //Modified by FK 17-4-2017
...
#define FAN_KICKSTART_TIME 200 //Modified by FK 17-4-2017

// This defines the minimal speed for the main fan, run in PWM mode
// to enable uncomment and set minimal PWM speed for reliable running (1-255)
// if fan speed is [1 - (FAN_MIN_PWM-1)] it is set to FAN_MIN_PWM
#define FAN_MIN_PWM 50 //Modified by FK 17-4-2017
...
#define CASE_LIGHT_PIN 6 //Modified by FK 17-4-2017
#if PIN_EXISTS(CASE_LIGHT)
  #define INVERT_CASE_LIGHT false   // Set to true if HIGH is the OFF state (active low)
#define CASE_LIGHT_DEFAULT_ON  //Modified by FK 17-4-2017
#define MENU_ITEM_CASE_LIGHT  //Modified by FK 17-4-2017
#endif
...
#define DUAL_X_CARRIAGE  //Modified by FK 17-4-2017
#if ENABLED(DUAL_X_CARRIAGE)
  // Configuration for second X-carriage
  // Note: the first x-carriage is defined as the x-carriage which homes to the minimum endstop;
  // the second x-carriage always homes to the maximum endstop.
#define X2_MIN_POS 0 //Modified by FK 17-4-2017
#define X2_MAX_POS 332 //Modified by FK 17-4-2017
#define X2_HOME_DIR 1 //Modified by FK 17-4-2017
#define X2_HOME_POS X2_MAX_POS //Modified by FK 17-4-2017
...
#define DEFAULT_DUAL_X_CARRIAGE_MODE DXC_FULL_CONTROL_MODE //Modified by FK 17-4-2017

  // Default settings in "Auto-park Mode"
#define TOOLCHANGE_PARK_ZLIFT 1 //Modified by FK 17-4-2017
#define TOOLCHANGE_UNPARK_ZLIFT 1 //Modified by FK 17-4-2017

  // Default x offset in duplication mode (typically set to half print bed width)
#define DEFAULT_DUPLICATION_X_OFFSET 150 //Modified by FK 17-4-2017
...
#define HOMING_BUMP_DIVISOR {2, 2, 4} //Modified by FK 17-4-2017
//#define QUICK_HOME  //if this is defined, if both x and y are to be homed, a diagonal move will be performed initially.

// When G28 is called, this option will make Y home before X
#define HOME_Y_BEFORE_X  //Modified by FK 17-4-2017
...
#define USE_WATCHDOG  //Modified by FK 17-4-2017
...
#define BABYSTEPPING  //Modified by FK 17-4-2017
#if ENABLED(BABYSTEPPING)
//#define BABYSTEP_XY  //Modified by FK 17-4-2017
                       //not implemented for deltabots!
#define BABYSTEP_INVERT_Z false //Modified by FK 17-4-2017
#define BABYSTEP_MULTIPLICATOR 40 //Modified by FK 17-4-2017
#endif
 ...
 */
//#define LIN_ADVANCE  //Modified by FK 17-4-2017

#if ENABLED(LIN_ADVANCE)
//#define LIN_ADVANCE_K 50 //Modified by FK 17-4-2017
#endif
...
//#define ARC_SUPPORT  //Modified by FK 17-4-2017
